# Individual Contributor License Agreement (v1.0, SAGEA)
...
past and future “Contributions” submitted to the **SAGEA RUNE CLI project
(the “Project”)**.
...
You grant **SAGEA LABS PVT. LTD.** and all recipients of software distributed by the
...
You grant **SAGEA LABS PVT. LTD.** and all recipients of the Project a perpetual,
...
entity under this CLA terminate automatically.

## 4. Representations

1. You are legally entitled to grant the licenses above under Nepalese law.
...
This Agreement is governed by the laws of **Nepal**, excluding its conflict-of-laws
rules. Any dispute arising out of or relating to this Agreement shall be subject
to the exclusive jurisdiction of the courts of **Kathmandu, Nepal**.

---

SAGEA RUNE CLI Project
https://sagea.space
