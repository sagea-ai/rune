...
class SnapshotTestAppWithWhatsNew(BaseSnapshotTestApp):
    def __init__(self, gateway: FakeWhoAmIGateway | None = None):
        self._previous_api_key = os.environ.get("RUNE_API_KEY")
        os.environ["RUNE_API_KEY"] = "snapshot-api-key"
    ...
    def on_unmount(self) -> None:
        if self._previous_api_key is None:
            os.environ.pop("RUNE_API_KEY", None)
        else:
            os.environ["RUNE_API_KEY"] = self._previous_api_key
        return None
