...
def config_dir(
    ...
    monkeypatch.setattr(global_paths, "_DEFAULT_RUNE_HOME", config_dir)
    return config_dir
...
def _mock_api_key(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("RUNE_API_KEY", "mock")
...
def _mock_update_commands(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("rune.cli.update_notifier.update.UPDATE_COMMANDS", ["true"])
