...
async def test_retrieves_nothing_when_no_versions_are_available() -> None:
    ...
    async with httpx.AsyncClient(transport=transport, base_url=PYPI_API_URL) as client:
        gateway = PyPIUpdateGateway(project_name="rune-cli", client=client)
...
async def test_retrieves_the_latest_non_yanked_version() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        assert request.url.path == "/simple/rune-cli/"
        return httpx.Response(
            ...
            json={
                ...
                "files": [
                    {
                        "filename": "rune_cli-1.0.0-py3-none-any.whl",
                        "yanked": False,
                    },
                    {"filename": "rune_cli-1.0.1-py3-none-any.whl", "yanked": True},
                    {
                        "filename": "rune_cli-1.0.2-py3-none-any.whl",
                        "yanked": False,
                    },
                ],
            },
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        return httpx.Response(
            ...
            json={
                "versions": ["1.0.0"],
                "files": [
                    {"filename": "rune_cli-1.0.0-py3-none-any.whl", "yanked": True}
                ],
            },
        )
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        return httpx.Response(
            ...
            json={
                ...
                "files": [
                    {
                        "filename": "rune_cli-1.0.10-py3-none-any.whl",
                        "yanked": False,
                    }
                ],
            },
