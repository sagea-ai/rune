...
from rune.cli.clipboard import _copy_osc52, copy_selection_to_clipboard
...
@patch("rune.cli.clipboard._copy_osc52")
...
def test_copy_selection_to_clipboard_multiple_widgets(mock_app: MagicMock) -> None:
    ...
    with patch("rune.cli.clipboard._copy_osc52") as mock_copy_osc52:
        copy_selection_to_clipboard(mock_app)
