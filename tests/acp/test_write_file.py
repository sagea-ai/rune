...
from rune.acp.tools.builtins.write_file import AcpWriteFileState, WriteFile
from rune.core.tools.base import ToolError
from rune.core.tools.builtins.write_file import (
    WriteFileArgs,
    WriteFileConfig,
    WriteFileResult,
)
...
class TestAcpWriteFileSessionUpdates:
    ...
    def test_tool_call_session_update_invalid_args(self) -> None:
        from rune.core.types import FunctionCall, ToolCall
