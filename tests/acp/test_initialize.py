...
class TestACPInitialize:
    ...
    async def test_initialize(self, acp_agent_loop: RuneAcpAgentLoop) -> None:
        ...
        assert response.agent_info == Implementation(
            name="@runeai/rune-cli", title="Rune", version="2.1.0"
        )
    ...
    async def test_initialize_with_terminal_auth(
        ...
        assert auth_method.description == "Register your API Key inside Rune"
        ...
        assert terminal_auth_meta["label"] == "Rune Setup"
