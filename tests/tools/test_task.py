...
from rune.core.tools.builtins.task import Task, TaskArgs, TaskResult, TaskToolConfig
from rune.core.types import AssistantEvent, LLMMessage, Role
...
class TestTaskToolExecution:
    ...
    async def test_happy_path_returns_subagent_response(
        ...
        with patch("rune.core.tools.builtins.task.AgentLoop") as mock_agent_loop_class:
