...
**Rune is a powerful CLI coding agent powered by Ollama and Sage Reasoning models.**
...
```bash
git clone https://github.com/runeai/rune-cli.git
cd rune-cli
pip install -e .
```
...
Rune is a fork of [Mistral Vibe](https://github.com/mistralai/mistral-vibe), originally developed by Mistral AI.
