...
use chrono::Utc;
use rune_app_server_protocol::Account;
...
use rune_app_server_protocol::AuthStatusChangeNotification;
use rune_app_server_protocol::CancelLoginAccountParams;
use rune_app_server_protocol::CancelLoginAccountResponse;
use rune_app_server_protocol::CancelLoginAccountStatus;
use rune_app_server_protocol::CancelLoginChatGptResponse;
use rune_app_server_protocol::ClientRequest;
use rune_app_server_protocol::CollaborationModeListParams;
use rune_app_server_protocol::CollaborationModeListResponse;
use rune_app_server_protocol::CommandExecParams;
use rune_app_server_protocol::ConversationGitInfo;
use rune_app_server_protocol::ConversationSummary;
use rune_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use rune_app_server_protocol::ExecOneOffCommandResponse;
use rune_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
use rune_app_server_protocol::ExperimentalFeatureListParams;
use rune_app_server_protocol::ExperimentalFeatureListResponse;
use rune_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use rune_app_server_protocol::FeedbackUploadParams;
use rune_app_server_protocol::FeedbackUploadResponse;
use rune_app_server_protocol::ForkConversationParams;
use rune_app_server_protocol::ForkConversationResponse;
use rune_app_server_protocol::FuzzyFileSearchParams;
use rune_app_server_protocol::FuzzyFileSearchResponse;
use rune_app_server_protocol::GetAccountParams;
use rune_app_server_protocol::GetAccountRateLimitsResponse;
use rune_app_server_protocol::GetAccountResponse;
use rune_app_server_protocol::GetAuthStatusParams;
use rune_app_server_protocol::GetAuthStatusResponse;
use rune_app_server_protocol::GetConversationSummaryParams;
use rune_app_server_protocol::GetConversationSummaryResponse;
use rune_app_server_protocol::GetUserAgentResponse;
use rune_app_server_protocol::GetUserSavedConfigResponse;
use rune_app_server_protocol::GitDiffToRemoteResponse;
use rune_app_server_protocol::GitInfo as ApiGitInfo;
use rune_app_server_protocol::InputItem as WireInputItem;
...
use rune_app_server_protocol::ListMcpServerStatusParams;
use rune_app_server_protocol::ListMcpServerStatusResponse;
use rune_app_server_protocol::LoginAccountParams;
use rune_app_server_protocol::LoginAccountResponse;
...
use rune_app_server_protocol::LogoutAccountResponse;
use rune_app_server_protocol::LogoutChatGptResponse;
use rune_app_server_protocol::McpServerOauthLoginCompletedNotification;
use rune_app_server_protocol::McpServerOauthLoginParams;
use rune_app_server_protocol::McpServerOauthLoginResponse;
use rune_app_server_protocol::McpServerRefreshResponse;
use rune_app_server_protocol::McpServerStatus;
use rune_app_server_protocol::MockExperimentalMethodParams;
use rune_app_server_protocol::MockExperimentalMethodResponse;
...
use rune_app_server_protocol::RemoveConversationSubscriptionResponse;
use rune_app_server_protocol::ResumeConversationParams;
use rune_app_server_protocol::ResumeConversationResponse;
use rune_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use rune_app_server_protocol::ReviewStartParams;
use rune_app_server_protocol::ReviewStartResponse;
use rune_app_server_protocol::ReviewTarget as ApiReviewTarget;
...
use rune_app_server_protocol::SkillsConfigWriteParams;
use rune_app_server_protocol::SkillsConfigWriteResponse;
use rune_app_server_protocol::SkillsListParams;
use rune_app_server_protocol::SkillsListResponse;
use rune_app_server_protocol::SkillsRemoteReadParams;
use rune_app_server_protocol::SkillsRemoteReadResponse;
use rune_app_server_protocol::SkillsRemoteWriteParams;
use rune_app_server_protocol::SkillsRemoteWriteResponse;
use rune_app_server_protocol::Thread;
...
use rune_app_server_protocol::ThreadForkResponse;
...
use rune_app_server_protocol::ThreadLoadedListResponse;
...
use rune_app_server_protocol::ThreadSetNameParams;
use rune_app_server_protocol::ThreadSetNameResponse;
use rune_app_server_protocol::ThreadSortKey;
...
use rune_app_server_protocol::ThreadUnarchiveResponse;
...
use rune_app_server_protocol::TurnSteerResponse;
use rune_app_server_protocol::UserInfoResponse;
...
use rune_core::Cursor as RolloutCursor;
use rune_core::InitialHistory;
use rune_core::NewThread;
use rune_core::RolloutRecorder;
use rune_core::SessionMeta;
use rune_core::SteerInputError;
use rune_core::ThreadConfigSnapshot;
use rune_core::ThreadManager;
use rune_core::ThreadSortKey as CoreThreadSortKey;
use rune_core::auth::AuthMode as CoreAuthMode;
use rune_core::auth::CLIENT_ID;
use rune_core::auth::login_with_api_key;
use rune_core::auth::login_with_chatgpt_auth_tokens;
...
use rune_core::git_info::git_diff_to_remote;
use rune_core::mcp::collect_mcp_snapshot;
use rune_core::mcp::group_tools_by_server;
use rune_core::parse_cursor;
use rune_core::protocol::EventMsg;
use rune_core::protocol::Op;
use rune_core::protocol::ReviewDelivery as CoreReviewDelivery;
use rune_core::protocol::ReviewRequest;
use rune_core::protocol::ReviewTarget as CoreReviewTarget;
use rune_core::protocol::SessionConfiguredEvent;
use rune_core::read_head_for_summary;
use rune_core::read_session_meta_line;
use rune_core::rollout_date_parts;
use rune_core::sandboxing::SandboxPermissions;
use rune_core::skills::remote::download_remote_skill;
use rune_core::skills::remote::list_remote_skills;
use rune_core::state_db::StateDbHandle;
use rune_core::state_db::open_if_present;
...
use rune_login::ServerOptions as LoginServerOptions;
...
use rune_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use rune_protocol::items::TurnItem;
use rune_protocol::models::ResponseItem;
use rune_protocol::protocol::AgentStatus;
use rune_protocol::protocol::GitInfo as CoreGitInfo;
use rune_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
...
use rune_protocol::user_input::UserInput as CoreInputItem;
use rune_rmcp_client::perform_oauth_login_return_url;
use rune_utils_json_to_toml::json_to_toml;
...
/// Handles JSON-RPC messages for Rune threads (and legacy conversation APIs).
pub(crate) struct RuneMessageProcessor {
...
pub(crate) struct RuneMessageProcessorArgs {
...
impl RuneMessageProcessor {
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<RuneThread>), JSONRPCErrorError> {
    ...
    pub fn new(args: RuneMessageProcessorArgs) -> Self {
        let RuneMessageProcessorArgs {
            auth_manager,
            thread_manager,
            outgoing,
    ...
    async fn load_latest_config(&self) -> Result<Config, JSONRPCErrorError> {
        ...
        rune_core::config::ConfigBuilder::default()
    ...
    fn review_request_from_target(
        ...
        let hint = rune_core::review_prompts::user_facing_hint(&core_target);
    ...
    pub async fn process_request(&mut self, connection_id: ConnectionId, request: ClientRequest) {
        ...
        match request {
            ...
            | ClientRequest::ConfigBatchWrite { .. } => {
                warn!("Config request reached RuneMessageProcessor unexpectedly");
            }
            ClientRequest::ConfigRequirementsRead { .. } => {
                warn!("ConfigRequirementsRead request reached RuneMessageProcessor unexpectedly");
            }
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = rune_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = rune_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn login_chatgpt_auth_tokens(
        ...
        if let Err(err) =
            login_with_chatgpt_auth_tokens(&self.config.rune_home, &id_token, &access_token)
        {
            let error = JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
    ...
    async fn fetch_account_rate_limits(&self) -> Result<CoreRateLimitSnapshot, JSONRPCErrorError> {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "rune account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch rune rate limits: {err}"),
                data: None,
            })
    }

    async fn get_user_saved_config(&self, request_id: ConnectionRequestId) {
        let service = ConfigService::new_with_defaults(self.config.rune_home.clone());
    ...
    async fn exec_one_off_command(
        ...
        let rune_linux_sandbox_exe = self.config.rune_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        tokio::spawn(async move {
            match rune_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &rune_linux_sandbox_exe,
    ...
    async fn process_new_conversation(
        ...
        let typesafe_overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            rune_linux_sandbox_exe: self.rune_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<rune_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(rune_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_archive(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.rune_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .rune_home
            .join(rune_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.rune_home.join(rune_core::SESSIONS_SUBDIR);
    ...
    async fn thread_read(&mut self, request_id: ConnectionRequestId, params: ThreadReadParams) {
        ...
        if rollout_path.is_none() || include_turns {
            rollout_path =
                match find_thread_path_by_id_str(&self.config.rune_home, &thread_uuid.to_string())
                    .await
                {
            ...
            .await
        {
            ...
            Err(err) => {
                let (code, message) = match err {
                    RuneErr::Io(_) | RuneErr::Json(_) => (
                        INVALID_REQUEST_ERROR_CODE,
                        format!("failed to load rollout `{}`: {err}", rollout_path.display()),
                    ),
                    RuneErr::InvalidRequest(message) => (INVALID_REQUEST_ERROR_CODE, message),
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.rune_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match rune_core::find_thread_path_by_id_str(
                    &self.config.rune_home,
    ...
    async fn handle_resume_conversation(
        ...
        let thread_history = if let Some(path) = path {
            ...
            match find_thread_path_by_id_str(&self.config.rune_home, &conversation_id.to_string())
                .await
            {
                Ok(Some(found_path)) => {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.rune_home.join(rune_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: ConnectionRequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(rune_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_remote_read(
        ...
        match list_remote_skills(&self.config).await {
            Ok(skills) => {
                let data = skills
                    .into_iter()
                    .map(|skill| rune_app_server_protocol::RemoteSkillSummary {
                        id: skill.id,
                        name: skill.name,
    ...
    async fn skills_config_write(
        ...
        let result = ConfigEditsBuilder::new(&self.config.rune_home)
            .with_edits(edits)
            .apply()
            .await;
    ...
    async fn start_detached_review(
        ...
        let rollout_path =
            find_thread_path_by_id_str(&self.config.rune_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
                    ...
                    event = conversation.next_event() => {
                        ...
                        outgoing_for_task
                            .send_notification(OutgoingNotification {
                                method: format!("rune/event/{event_formatted}"),
...
fn skills_to_info(
    skills: &[rune_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<rune_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path);
            rune_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    rune_app_server_protocol::SkillInterface {
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    rune_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| rune_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[rune_core::skills::SkillError],
) -> Vec<rune_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| rune_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(
    ...
    for tool in tools {
        ...
        if let Err(err) = rune_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
async fn sync_default_client_residency_requirement(
    ...
    let loader = cloud_requirements
        ...
        .map(|guard| guard.clone())
        .unwrap_or_default();
    match rune_core::config::ConfigBuilder::default()
...
async fn read_history_cwd_from_state_db(
    ...
    if let Some(state_db_ctx) =
        open_if_present(&config.rune_home, config.model_provider_id.as_str()).await
...
async fn read_summary_from_state_db_by_thread_id(
    ...
    let state_db_ctx = open_if_present(&config.rune_home, config.model_provider_id.as_str()).await;
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = it
            .source
            .unwrap_or(rune_protocol::protocol::SessionSource::Unknown);
...
pub(crate) async fn read_event_msgs_from_rollout(
    path: &Path,
) -> std::io::Result<Vec<rune_protocol::protocol::EventMsg>> {
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match rune_core::parse_turn_item(&item) {
