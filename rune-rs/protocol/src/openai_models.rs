//! Shared model metadata types exchanged between Rune services and clients.
//!
...
/// Metadata describing a Rune-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Rune backend `/models` endpoint.
