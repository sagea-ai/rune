...
//! `schemars`) so they can be embedded in Rune's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `rune-protocol` so other crates can convert
