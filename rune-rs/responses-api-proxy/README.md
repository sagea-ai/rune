...
- We leverage [`codex_process_hardening`](https://github.com/openai/codex/blob/main/rune-rs/process-hardening/README.md) so `rune-responses-api-proxy` is run with standard process-hardening techniques.
