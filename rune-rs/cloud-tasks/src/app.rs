...
pub struct EnvironmentRow {
    ...
    pub is_pinned: bool,
    pub repo_hints: Option<String>, // e.g., "openai/rune"
}
...
use rune_cloud_tasks_client::CloudBackend;
...
pub struct AttemptView {
    ...
    pub status: rune_cloud_tasks_client::AttemptStatus,
...
pub enum AppEvent {
    ...
    DetailsMessagesLoaded {
        ...
        attempt_status: rune_cloud_tasks_client::AttemptStatus,
    },
    DetailsFailed {
        id: TaskId,
        title: String,
    ...
    AttemptsLoaded {
        id: TaskId,
        attempts: Vec<rune_cloud_tasks_client::TurnAttempt>,
    },
    /// Background completion of new task submission
    NewTaskSubmitted(Result<rune_cloud_tasks_client::CreatedTask, String>),
    ...
    ApplyFinished {
        id: TaskId,
        result: std::result::Result<rune_cloud_tasks_client::ApplyOutcome, String>,
    },
}
...
mod tests {
    use super::*;
    use chrono::Utc;
    use rune_cloud_tasks_client::CloudTaskError;
    ...
    impl rune_cloud_tasks_client::CloudBackend for FakeBackend {
        async fn list_tasks(
            &self,
            env: Option<&str>,
            limit: Option<i64>,
            cursor: Option<&str>,
        ) -> rune_cloud_tasks_client::Result<rune_cloud_tasks_client::TaskListPage> {
            ...
            for (i, t) in titles.into_iter().enumerate() {
                out.push(TaskSummary {
                    ...
                    title: t.to_string(),
                    status: rune_cloud_tasks_client::TaskStatus::Ready,
                    updated_at: Utc::now(),
                    environment_id: env.map(str::to_string),
                    environment_label: None,
                    summary: rune_cloud_tasks_client::DiffSummary::default(),
                    is_review: false,
            ...
            Ok(rune_cloud_tasks_client::TaskListPage {
                tasks: limited,
        ...
        async fn get_task_summary(
            &self,
            id: TaskId,
        ) -> rune_cloud_tasks_client::Result<TaskSummary> {
        ...
        async fn get_task_diff(
            &self,
            _id: TaskId,
        ) -> rune_cloud_tasks_client::Result<Option<String>> {
            Err(rune_cloud_tasks_client::CloudTaskError::Unimplemented(
                "not used in test",
            ))
        }
        ...
        async fn get_task_messages(
            &self,
            _id: TaskId,
        ) -> rune_cloud_tasks_client::Result<Vec<String>> {
            Ok(vec![])
        }
        async fn get_task_text(
            &self,
            _id: TaskId,
        ) -> rune_cloud_tasks_client::Result<rune_cloud_tasks_client::TaskText> {
            Ok(rune_cloud_tasks_client::TaskText {
                prompt: Some("Example prompt".to_string()),
                messages: Vec::new(),
                turn_id: Some("fake-turn".to_string()),
                sibling_turn_ids: Vec::new(),
                attempt_placement: Some(0),
                attempt_status: rune_cloud_tasks_client::AttemptStatus::Completed,
            })
        }
        ...
        async fn list_sibling_attempts(
            ...
            _task: TaskId,
            _turn_id: String,
        ) -> rune_cloud_tasks_client::Result<Vec<rune_cloud_tasks_client::TurnAttempt>> {
            Ok(Vec::new())
        }
        ...
        ) -> rune_cloud_tasks_client::Result<rune_cloud_tasks_client::ApplyOutcome> {
            Err(rune_cloud_tasks_client::CloudTaskError::Unimplemented(
                "not used in test",
            ))
        }
        ...
        async fn create_task(
            ...
            _qa_mode: bool,
            _best_of_n: usize,
        ) -> rune_cloud_tasks_client::Result<rune_cloud_tasks_client::CreatedTask> {
            Err(rune_cloud_tasks_client::CloudTaskError::Unimplemented(
                "not used in test",
            ))
        }
