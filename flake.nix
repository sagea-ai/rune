  ...
  outputs = {
    ...
    in {
      ...
      packages.default = mkApplication {
        venv = pythonSet.mkVirtualEnv "runeai-vibe-env" workspace.deps.default;
        package = pythonSet.rune-cli;
      };
        ...
        default = let
          ...
          editablePythonSet = pythonSet.overrideScope (
            lib.composeManyExtensions [
              ...
              (final: prev: {
                runeai-vibe = prev.runeai-rune.overrideAttrs (old: {
          ...
          virtualenv = editablePythonSet.mkVirtualEnv "runeai-vibe-dev-env" workspace.deps.all;
        in
          pkgs.mkShell {
            packages = [
              virtualenv
