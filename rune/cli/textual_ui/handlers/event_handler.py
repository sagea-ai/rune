...
from rune.cli.textual_ui.widgets.messages import AssistantMessage, ReasoningMessage
...
from rune.core.utils import TaggedText

if TYPE_CHECKING:
    from rune.cli.textual_ui.widgets.loading import LoadingWidget
