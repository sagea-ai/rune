...
from rune.core.trusted_folders import TRUSTABLE_FILENAMES, trusted_folders_manager
from rune.core.utils import is_dangerous_directory, is_windows

if TYPE_CHECKING:
    from rune.core.agents import AgentManager
    from rune.core.config import ProjectContextConfig, RuneConfig
...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Rune with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by Rune.\n"
        "Co-Authored-By: Rune <rune@sagea.ai>\n"
        "```"
    )
